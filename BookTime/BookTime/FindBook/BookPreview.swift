...
//
//                Text(book.authors?.joined(separator: ", ") ?? "Nieznany autor")
//                    .font(.subheadline)
...
//                    .font(.headline)
//                } else {
//                    Text("Brak informacji o liczbie stron")
//                        .font(.subheadline)
//                        .foregroundColor(.gray)
//                }
//
...
//                    }) {
//                        Label("Ulubione", systemImage: firebaseManager.isBookInCollection(book: book, collection: "favorites") ? "star.fill" : "star")
//                            .foregroundColor(firebaseManager.isBookInCollection(book: book, collection: "favorites") ? .yellow : .primary)
//                    }
...
//                    }) {
//                        Label("Zapisz", systemImage: firebaseManager.isBookInCollection(book: book, collection: "saved") ? "bookmark.fill" : "bookmark")
//                            .foregroundColor(firebaseManager.isBookInCollection(book: book, collection: "saved") ? .blue : .primary)
//                    }
//                    .buttonStyle(.bordered)
//
//                    // Recenzja
...
//                        showReviewView = true
//                    }) {
//                        Label("Recenzja", systemImage: "pencil")
//                    }
...
//                    }) {
//                        Label("Przeczytane", systemImage: firebaseManager.isBookInCollection(book: book, collection: "read") ? "checkmark.circle.fill" : "checkmark.circle")
//                            .foregroundColor(firebaseManager.isBookInCollection(book: book, collection: "read") ? .green : .primary)
//                    }
//                    .buttonStyle(.bordered)
//                }
//            }
//            .padding()
//        }
//        .navigationBarTitle("Podgląd książki", displayMode: .inline)
//    }
//}
struct BookPreview: View {
    let book: Book
